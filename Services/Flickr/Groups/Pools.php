...
/**
 * Flickr API's groups pools class
 *
 ...
 * @link       http://pear.php.net/package/Services_Flickr
 */
class Services_Flickr_Groups_Pools extends Services_Flickr_Common
{
    protected $group = 'groups.pools';
